...
func (m model) helpEntries() []helpEntry {
	items := []helpEntry{
		...
		{"Ctrl+D", "光标向下半屏", "从当前选中项向下移动约半屏，画面跟随光标居中。长回复和嵌套引用先在正文内前进半屏，不跳过尚未看完的内容。"},
		{"Ctrl+U", "光标向上半屏", "从当前选中项向上移动约半屏，画面跟随光标居中。长回复和嵌套引用先在正文内向上浏览。"},
